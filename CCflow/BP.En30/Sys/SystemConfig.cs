    ...
    public class SystemConfig
    {
        ...
        public static string PathOfWebApp
        {
            get
            {
                if (SystemConfig.IsBSsystem)
                {
                    return BP.Sys.Glo.Request.PhysicalApplicationPath+ "Areas\\Workflow\\";
                }
                else
                {
        ...
        public static string AppCenterDSN
        {
            get
            {
                if (AppSettings["AppCenterDBType"] == null && System.Web.Configuration.WebConfigurationManager.ConnectionStrings["DefaultConnection"] != null)
                {
                    var connStr = System.Web.Configuration.WebConfigurationManager.ConnectionStrings["DefaultConnection"];
                    _AppCenterDSN = connStr.ConnectionString;
