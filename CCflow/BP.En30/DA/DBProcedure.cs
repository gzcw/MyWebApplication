...
namespace BP.DA
{
	...
	{		 
        ...
        public static int RunSP(string spName, Paras paras, OracleConnection conn)
        {
            ...
            foreach (Para para in paras)
            {
                OracleParameter myParameter = new OracleParameter(para.ParaName, OracleDbType.Varchar2);
        ...
        public static DataTable RunSPReturnDataTable(string spName, Paras paras, OracleConnection conn)
        {
            ...
            foreach (Para para in paras)
            {
                OracleParameter myParm = salesCMD.Parameters.Add(para.ParaName, para.DAType);
