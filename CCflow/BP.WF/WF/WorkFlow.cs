...
#warning 此处需要修复。
            ...
            //注释【删除工作者】，增加更新工作者状态
            ps = new Paras();
            ps.SQL = "UPDATE WF_GenerWorkerlist SET ISPASS=1 WHERE WorkID=" + dbstr + "WorkID1 AND FK_NODE=" + dbstr + "FK_NODE AND FK_EMP=" + dbstr+"FK_EMP";
            ps.Add("WorkID1", this.WorkID);
            ps.Add("FK_NODE", this.HisGenerWorkFlow.FK_Node);
            ps.Add("FK_EMP", WebUser.No);
            var dd= DBAccess.RunSQL(ps);
